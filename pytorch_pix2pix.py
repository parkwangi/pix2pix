...
for epoch in range(opt.train_epoch):
    ...
    for x_, _ in train_loader:
        ...
        G_train_loss = BCE_loss(D_result, Variable(torch.ones(D_result.size()))) + opt.L1_lambda * L1_loss(G_result, y_)
    ...
    util.show_result(G, Variable(fixed_x_, volatile=True), fixed_y_, (epoch+1), save=True, path=fixed_p)
